...
LAYOFFS_PATH = "tech_layoffs_v2_cleaned.csv"
JOBS_PATH    = "ai_jobs_2026_cleaned.csv"
OUTPUT_PATH  = "jobs_enriched_with_layoffs_complete.csv.gz"
...
combined["Salary Range"] = combined.apply(
    lambda r: f"€{int(round(r['salary_low_eur'])):,} - €{int(round(r['salary_high_eur'])):,}"
